...
exports.config = {
    ...
    specs: [
        './WiproTest/test/features/*.feature',
    ],
    // Patterns to exclude.
    exclude: [
   ...
   // reporters: ['spec', 'junit','allure', 'json'],
    ...
    cucumberOpts: {
        require: ['./WiproTest/test/stepDefinitions/given.js', './WiproTest/test/stepDefinitions/when.js', './WiproTest/test/stepDefinitions/then.js'],   // <string[]> (file/dir) require files before executing features
